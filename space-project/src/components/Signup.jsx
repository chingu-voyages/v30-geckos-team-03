      ...
      <div className="row">
        <div className="col-md-8 signup-content">
          <p className="signup-p">
            Do you want asteroids to head straight for your inbox?
          </p>
          ...
          <form>
            ...
            <p className="terms">
              By clicking submit, you agree to the terms of service and our
              privacy policy.{" "}
            </p>
        ...
        <div className="col-md-4 signup-content">
          ...
          <div>
            {!submitted ? (
              ...
              <p>You've successfully signed up for our asteroid newsletter.</p>
            )}
          </div>
        </div>
      </div>
