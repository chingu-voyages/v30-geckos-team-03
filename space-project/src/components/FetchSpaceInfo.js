...
import AsteroidDetails from "./AsteroidDetails.jsx";
...
const FetchSpaceInfo = () => {
  ...
  useEffect(() => {
    ...
    let astros = astro_list_compiled.map(function compile(myitem) {
      return (
        <ul>
