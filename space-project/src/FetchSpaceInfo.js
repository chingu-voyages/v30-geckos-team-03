    ...
    return (
      <div>
        ...
        <div>
          Close Approach Date:{" "}
          {
            this.state.information["2015-09-07"][0].close_approach_data[0]
        ...
        <div>
          Dangerous?:{" "}
          {
            this.state.information["2015-09-07"][0]
        ...
        <div>
          ...
          {
            this.state.information["2015-09-07"][0].estimated_diameter.feet
        ...
        <div>
          ...
          {
            this.state.information["2015-09-07"][0].estimated_diameter.meters
              .estimated_diameter_min
          }
        </div>
        <div>
